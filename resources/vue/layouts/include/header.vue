                            ...
                            <div class="p-2">
                                <div class="grid grid-cols-3">
                                    <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                                       href="#">
                                        <img src="images/brands/github.png" class="mb-2 mx-auto h-6"
                                             alt="Github">
                                        <span>GitHub</span>
                                    </a>
                                    <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                                       href="#">
                                        <img src="images/brands/bitbucket.png" class="mb-2 mx-auto h-6"
                                             alt="Github">
                                        <span>Bitbucket</span>
                                    </a>
                                    <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                                       href="#">
                                        <img src="images/brands/dribbble.png" class="mb-2 mx-auto h-6"
                                             alt="Github">
                                        <span>Dribbble</span>
                                    </a>
                                </div>
                                <div class="grid grid-cols-3">
                                    <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                                       href="#">
                                        <img src="images/brands/dropbox.png" class="mb-2 mx-auto h-6"
                                             alt="Github">
                                        <span>Dropbox</span>
                                    </a>
                                    <a class="dropdown-item hover:bg-gray-50/50 py-4 text-center dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                                       href="#">
                                        <img src="images/brands/mail_chimp.png" class="mb-2 mx-auto h-6"
                                             alt="Github">
            ...
            <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="tables-editable.html"
                                   class="pl-14 pr-4  py-2 block text-sm font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">Editable </a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="sidebar-alert text-center mx-5 my-12">
                    <div class="card-body bg-primary rounded bg-violet-50/50 dark:bg-zinc-700/60">
                        <img src="images/giftbox.png" alt="" class="block mx-auto">
                        <div class="mt-4">
                            ...
                            <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#"
                                           class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">Dashboard</a>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body">
                            ...
                            <div class="flex items-center">
                                <span
                                    class="text-xs py-[1px] px-1 bg-red-50/60 text-red-500 rounded font-medium dark:bg-red-500/30">- 29 Trades</span>
                                <span class="ltr:ml-1.5 rtl:mr-1.5 text-gray-700 text-13 dark:text-zinc-100">Since last week</span>
                            </div>
                        </div>
                    </div>
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <div class="card-body">
                            ...
                            <div class="flex items-center">
                                <span
                                    class="text-xs py-[1px] px-1 bg-green-50/60 text-green-500 rounded font-medium dark:bg-green-500/30">+ $2.8k</span>
                                <span class="ltr:ml-1.5 rtl:mr-1.5 text-gray-700 text-13 dark:text-zinc-100">Since last week</span>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-span-6">
                                                <div class="mt-4 mt-sm-0">
                                                    ...
                                                    <div class="grid grid-cols-12">
                                                        <div class="col-span-6">
                                                            <div>
                                                                <p class="mb-1 text-gray-700 dark:text-zinc-100 text-uppercase font-size-11">
                                                                    Income</p>
                                                                <h5 class="text-gray-800 dark:text-gray-100">$
                                                                    2632.46</h5>
                                                            </div>
                                                        </div>
                                                        <div class="col-span-6">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane block" id="buy-tab" role="tabpanel">
                                        <div class="ltr:float-right rtl:float-left ms-2">
                                            <h5 class="text-sm text-gray-700 dark:text-zinc-100"><i
                                                ...
                                                href="#!" class="text-reset underline  underline-offset-2">$4335.23</a>
                                            </h5>
                                        </div>
                                    ...
                                    <div class="tab-pane hidden" id="sell-tab" role="tabpanel">
                                        ...
                                        <div>
                                            <div class="form-group mb-3">
                                                <label class="block text-gray-700 dark:text-zinc-100 font-medium mb-2">Wallet
                                                    ID :</label>
                                                <input type="email"
                                                    ...
                                                    <td class="p-3">
                                                        <div>
                                                            <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">
                                                                Buy BTC</h5>
                                                            <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">14
                                                                Mar, 2021</p>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-3">
                                                        <div>
                                                            <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">
                                                                Sell ETH</h5>
                                                            <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">15
                                                                Mar, 2021</p>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-3">
                                                        <div>
                                                            <h5 class="text-sm mb-1  text-gray-700 dark:text-gray-100">
                                                                Buy LTC</h5>
                                                            <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">16
                                                                Mar, 2021</p>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-3">
                                                        <div>
                                                            <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">
                                                                Buy ETH</h5>
                                                            <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">17
                                                                Mar, 2021</p>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-3">
                                                        <div>
                                                            <h5 class="text-sm mb-1 text-gray-700 dark:text-gray-100">
                                                                Sell BTC</h5>
                                                            <p class="text-gray-600 dark:text-zinc-100 mb-0 text-xs">18
                                                                Mar, 2021</p>
                                                        </div>
                                                    </td>
                            ...
                            <div class="px-3" data-simplebar style="max-height: 352px;">
                                <ul class="overflow-hidden">
                                    <li class="flex pl-12 pb-6 relative">
                                        ...
                                        <div>
                                            <div class="flex">
                                                <div class="grow mr-4 ml-2 overflow-hidden w-72">
                                                    ...
                                                    <p class="text-13 overflow-hidden text-ellipsis whitespace-nowrap text-gray-500 dark:text-zinc-100">
                                        ...
                                        <div
                                            class="after:contant-[] after:absolute after:h-20 after:border-l-2 after:border-dashed after:border-gray-100 after:left-5 after:z-0 dark:after:border-zinc-600"></div>
                                    </li>
