<script>
import layout from '@/vue/layouts/_blank.vue'
                            ...
                            <div class="my-auto">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="flex">
                                            ...
                                            <button
                                                ...
                                                type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row mb-6">
                                ...
                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-gray-100">Don't have an account ? <a
                                        href="register.html" class="text-violet-500 font-semibold"> Signup now </a></p>
                                </div>
                            </div>

                            <div class=" text-center">
                                <p class="text-gray-500 dark:text-gray-100 relative mb-5">© Minia . Crafted with <i
                                    class="mdi mdi-heart text-red-400"></i> by Themesbrand</p>
                            </div>
                        </div>
                    </div>
                </div>
