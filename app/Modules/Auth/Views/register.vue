                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-500 mt-1 dark:text-zinc-100/60">Get your free Minia account
                                        now.</p>
                                </div>
                                        ...
                                        <div class="col">
                                            <div>
                                                <p class="text-gray-600 dark:text-zinc-100/60">By registering you agree
                                                    to the Minia <a href="#" class="text-violet-500">Terms of Use</a>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class=" text-center">
                                <p class="text-gray-500 relative mb-5 dark:text-gray-100">©
                                    Minia . Crafted with <i class="mdi mdi-heart text-red-400"></i> by Themesbrand
                                </p>
                            </div>
                        </div>
                    </div>
